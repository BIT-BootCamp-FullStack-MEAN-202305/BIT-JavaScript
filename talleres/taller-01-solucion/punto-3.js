...
// Proceso 
//     Verificar/Validar que el numero ingresado sea multiplo de 5

// Valores de salida
//     (string) --> 'Si, el número x es múltiplo 5'
//     o
//     (string) --> 'No, el número x no es múltiplo de 5'

const numero = parseInt( prompt( 'Ingresa un numero entero: ' ) );

const esMultiploDe5 = numero % 5 === 0; // true o false
